...
<br>
	...
	$query = "select * from orderr where owname='".$_SESSION['login_user']."'";
 ...
 ?>
	<tr>
		...
		<td bgcolor=transparent><font color=white size=2><?php echo $row['uname']; ?></font></td>
		...
		<td bgcolor=transparent><font color=white size=2><a href="action.php?select=<?php echo $row['sno'];?>">Select</a></font></td>
...
if(isset($_GET['delete']))
	...
	$query = "delete from order where sno='".$_GET['delete']."'";
	mysql_query($query);
