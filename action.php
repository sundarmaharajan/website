...
$query2 = "select * from orderr where sno='".$_GET['select']."'";
			//echo $query2;
...
<br>
	...
	<tr>
		<td class="col"><p><font color=#ff3300 size=2>Customer ID:</font></p></td>
...
if(isset($_POST['register'])){
	...
	$query = "update orderr set status='".$_POST['Roll']."' where sno= '".$_POST['sid']."'";
	echo $query;
