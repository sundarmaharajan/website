...
<th bgcolor=transparent><font color=white size=2>Book Now</font></th>		
			  
	</tr>
	
	<?php
	
	$query = "select * from truck where sta='approved'";
 ...
 ?>
	<tr>
		...
		<td bgcolor=transparent><font color=white size=2><a href="book.php?select=<?php echo $row['name'];?>">Book Now</a></font></td>
